...
INSERT INTO [dbo].[Translations]
           ([Id],[Created],[CreatedBy],[Modified],[ModifiedBy],[IsActive],[LanguageId],[LivingTextId],[Text],[Subject])
     VALUES
           (NEWID(),GETDATE(),@systemId,null,null,1,@huId,@currentText,'<p><span style=\"color: rgb(0, 0, 0); font-size: 18px;\">Kedves Felhasználó!</span></p><p><span style=\"color: rgb(0, 0, 0);\">Valaki értesítést kért elfelejtett jelszóról. Amennyiben nem ön volt, ezt az email figyelmen kívül hagyhatja. <br />Amennyiben Ön kért jelszóemlékeztetőt, kérem kattintson az alábbi linkre, és írja be a mellékelt verifikációs kódot, amely 24 óráig érvényes:</span></p><p><span style=\"color: rgb(0, 0, 0);\"><a href=\"#MAINURL#recoverpassword?#NEWGUID#\">#MAINURL#recoverpassword?#NEWGUID#</a></span></p><p><span style=\"font-size: 18px; color: rgb(0, 0, 0);\">Üdvözlettel:</span><br><span style=\"color: rgb(0, 0, 0); font-size: 18px;\">Voice-beat</span></p>','noreply - Elfelejtett jelszó')

INSERT INTO [dbo].[Translations]
           ([Id],[Created],[CreatedBy],[Modified],[ModifiedBy],[IsActive],[LanguageId],[LivingTextId],[Text],[Subject])
     VALUES
           (NEWID(),GETDATE(),@systemId,null,null,1,@enId,@currentText,'<p><span style=\"color: rgb(0, 0, 0); font-size: 18px;\">Dear User,</span></p><p><span style=\"color: rgb(0, 0, 0);\">Someone requested notification of a forgotten password. If you werent, you can ignore this email. <br />If you have requested a password reminder, please click on the link below and enter the attached verification code, which is valid for 24 hours:</span></p><p><span style=\"color: rgb(0, 0, 0);\"><a href=\"#MAINURL#recoverpassword?#NEWGUID#\">#MAINURL#recoverpassword?#NEWGUID#</a></span></p><p><span style=\"font-size: 18px; color: rgb(0, 0, 0);\">Best regards:</span><br><span style=\"color: rgb(0, 0, 0); font-size: 18px;\">Voice-beat</span></p>','noreply - Forgotten password')

...
export default class ServicesRooms extends React.Component<any>{
    public render() {
      ...
      return (
        <div>
          <><LivingText livingTextType={LivingTextTypeEnum.ServicesRooms}></LivingText></>
          <><Images imageSettings={imageSettings} imageType={ImageTypeEnum.RoomsPicture}></Images></>
        </div>
        );
    }
}
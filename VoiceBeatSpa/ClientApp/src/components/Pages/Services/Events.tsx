...
export default class ServicesEvents extends React.Component<any>{
    public render() {
      ...
      return (
        <div>
          <><LivingText livingTextType={LivingTextTypeEnum.ServicesEvents}></LivingText></>
          <><Images imageSettings={imageSettings} imageType={ImageTypeEnum.EventsPicture}></Images></>
        </div>
        );
    }
}